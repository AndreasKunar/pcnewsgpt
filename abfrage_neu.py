...
Änderung: eine Neuadaption von V0.1 OHNE langchain
...
Initialize LLM
"""
print(f"KI-Model {model_path} wird geöffnet...")
...
prompt_template = 'Verwende den folgenden Kontext, um die Frage \
am Ende zu beantworten. Wenn die Antwort keinen direkten Bezug zum Kontext hat, \
inkludiere den Text "Dies ist eine unsichere Antwort!" in der Antwort. \
Kontext: {}Frage: {}\nAntwort: '
...
while True:
    ...
    """
    # Context for test: 
    context = "Der Turingtest - Alan Turing formulierte 1950 die Idee, wie man feststellen könne, " +\
    "ob ein Computer ein dem Menschen gleichwertiges Denkvermögen besitzt. Der „Test“ war eine " +\
    "theoretische Skizze, die im  Zeitalter der Informatik und der künstlichen Intelligenz genauer" +\
    "und konkreter ausformuliert wurde (Dartmouth Conference 1956)."
    ...
    print(f"### Antwort ... (bitte um etwas Geduld):")
    for chunk in llm(
        prompt = prompt,
