"""
*** PCnewsGPT Wissensdatenbank-Dump ***
"""
...
"""
print(f"PCnewsGPT Dump der Wissensdatenbank in {persist_directory} (collection '{collection_name}') V0.1\n")
...
for j in range(items):
    ...
    print(f"({j+1}/{items}): {ids[j]}, '{metadatas[j]}', '{doc}'")
